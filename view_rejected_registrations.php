...
// Fetch the rejected registrations
$query = "SELECT * FROM user_form WHERE status = 'rejected'";
...
<head>
    ...
    <style>
        ...
        .Logout a.btn {
    background-color: #dc3545; /* Your desired red color */
    color: #fff;
    transition: background-color 0.3s ease;
}
...
<body>
    ...
    <div class="header-links">
        ...
        <section class="main-content">
            <h2>View Rejected Registrations</h2>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<p>No rejected registrations.</p>';
            }
            ?>
        </section>
